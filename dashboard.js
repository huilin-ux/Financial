...
function addDcaEntry(){
  ...
  const shares=parseInt(document.getElementById('dca-shares').value)||Math.floor(amt/price);
...
'2412':'中華電','2417':'圓剛','2449':'京元電子','2451':'創見','2454':'聯發科','2474':'可成',
...
// 3xxx 電子 / 半導體 / 通訊
'3005':'神基','3008':'大立光','3017':'奇鋐','3019':'亞光','3030':'德律','3034':'聯詠','3035':'智原','3037':'欣興','3041':'揚智',
'3045':'台灣大','3105':'穩懋','3231':'緯創','3260':'威剛','3406':'玉晶光','3443':'創意','3530':'晶相光','3552':'同致','3653':'健策',
'3661':'世芯-KY','3702':'大聯大',
// 4xxx 生技 / 化工 / 通訊
'4128':'中天','4174':'浩鼎','4737':'華廈','4763':'材料-KY','4904':'遠傳','4938':'和碩','4977':'眾達-KY',
// 5xxx 金融 / 半導體 / 食品 / 建設
'5306':'桂盟','5483':'中美晶','5522':'遠雄','5871':'中租-KY','5876':'上海商銀','5880':'合庫金',
// 6xxx 電子 / 半導體 / 軟體 / 生技
'6005':'群益證','6176':'瑞儀','6239':'力成','6271':'同欣電','6409':'旭隼','6415':'矽力-KY','6443':'元晶','6446':'藥華藥',
'6488':'環球晶','6505':'台塑化','6515':'穎崴','6531':'愛普','6533':'晶心科','6669':'緯穎','6770':'力積電',
// 8xxx 半導體 / 電子
'8069':'元太','8086':'宏捷科','8261':'富鼎',
// 9xxx 自行車 / 餐飲 / 工程
...
function autoName(tk,targetId){
  ...
  if(nm){el.value=nm;el.style.color='var(--green)';setTimeout(()=>{el.style.color='';},1000);}
}
